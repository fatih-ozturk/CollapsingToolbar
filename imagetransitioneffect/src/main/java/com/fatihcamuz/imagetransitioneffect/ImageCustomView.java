...
public class ImageCustomView extends ImageView {

    private static final long FRAME_DELAY = 1000 / 50;
    private final Matrix mMatrix = new Matrix();
    private TransitionGenerator mTransGen = new RandomTransition();
    ...
    public ImageCustomView(Context context, AttributeSet attrs, int defStyle) {
